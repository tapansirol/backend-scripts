...
sed 's/{{ NAMESPACE }}/'$namespace'/g' $scriptDir/../../pre-install/namespaceAdministration/ibm-ucd-prod-rb.yaml > $scriptDir/$namespace-ibm-ucd-prod-rb.yaml

# Delete the role binding for all service accounts in the current namespace
kubectl delete -f $scriptDir/$namespace-ibm-ucd-prod-rb.yaml -n $namespace

# Clean up - delete the temporary yaml file.
rm $scriptDir/$namespace-ibm-ucd-prod-rb.yaml
