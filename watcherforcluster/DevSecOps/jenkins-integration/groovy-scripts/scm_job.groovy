...
def id = props.getProperty('JENKINS_JOB_NAME')

def job_name = props.getProperty('JENKINS_JOB_NAME')
def branch = props.getProperty('GIT_BRANCH')
def repository = props.getProperty('GIT_REPO_URL')
def credentialId = props.getProperty('GIT_CREDENTIAL_ID')
def job_description = "jpetstore application"
